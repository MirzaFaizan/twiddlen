                    ...
                    <Grid iitem xs={12} sm={12} md={12}>
                        <Card>
                            ...
                            <CardBody>
                               ...
                               <Grid item xs={12}><Divider/><h4>Event Information</h4><Divider/></Grid>
                                ...
                                <Grid item xs={12}><Divider/><h4>Event Address Information</h4><Divider/></Grid>
                                <Grid item xs={12} sm={12} md={12}>
                                    <TextField
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventLocationTypeChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={12}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventpostalAddressChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={12}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventstreetAddressChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={3}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventcityNameChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={3}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventpostalCodeChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={3}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventstateNameChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={3}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleevnetcountryNameChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12} sm={12} md={12}>
                                    ...
                                    margin="dense"
                                    onChange={e=>{this.handleeventLocationAddressChange(e)}}
                                    variant="outlined"
                                    fullWidth={true}
                                    />
                                </Grid> 
                                <Grid item xs={12}><Divider/><h4>Latitude, Longitude</h4><Divider/></Grid>
                                ...
                                <Grid item xs={12}><Divider/><h4>Event Images</h4><Divider/></Grid>
                                ...
                                <Grid item xs={12}>
                                <Button variant="outlined" size="large" color="secondary" type="image" onClick={()=>{console.log(this.state)}}>
                                Submit
                                </Button> 
                                </Grid>
                            </CardBody>
